	...
	<script type="text/javascript">
		...
		function createElements(){
			...
			SBGridProperties.columns = [
				{caption : ['번호'],		ref : 'qna_id',		width : '80px',	  style : 'text-align:center',	type : 'output'},
				{caption : ['제목'],		ref : 'title',width : '600px',  style : 'text-align:center',	type : 'output'},
				{caption : ['작성자'],	ref : 'member',	width : '120px',	style : 'text-align:center',	type : 'input', typeinfo : {locale : 'ko'} },
				{caption : ['등록일'],		ref : 'qnadate',		width : '200px',	style : 'text-align:center',	type : 'datepicker', typeinfo : {locale : 'ko' , dateformat :'yymmdd'}, format : {type:'date', rule:'yyyy-mm-dd', origin : 'yyyymmdd' }},
				{caption : ['답변여부'],	ref : 'confirm',width : '130px',  style : 'text-align:center',	type : 'output'},
		...
		function gridClick(){
			...
			$("#idxvalue").text(JSON.stringify(datagrid.getRowData(1,false)));
			
			
			location.href="findQnAbyid.do?id="+ datagrid.getRowData(1, qna_id);
		};			
...
<body>
	...
	<div class="containers">
		...
		<a href="qnawrite.jsp"><button>글작성</button></a>
</body>
</html>